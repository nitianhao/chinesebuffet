// Script to update buffet review summaries from apify-reviews-cities.json based on placeId
...
async function updateReviewSummaries() {
  console.log('Reading apify-reviews-cities.json...');
  const jsonPath = path.join(__dirname, '../Example JSON/apify-reviews-cities.json');
  
  if (!fs.existsSync(jsonPath)) {
    console.error('Error: apify-reviews-cities.json not found');
    process.exit(1);
  }
