/**
 * Generate SEO-optimized "Healthcare & Medical Services" descriptions for buffets
 * 
 ...
 * 
 * Output stored in: buffets.healthcareMedicalServices (JSON string)
 * 
 * Note: This script has relaxed constraints to allow more POIs per buffet than usual.
 * 
 * Example commands:
 *   npx tsx scripts/generate-poi-healthcare-medical-services.ts --dry-run --limit 5
 *   npx tsx scripts/generate-poi-healthcare-medical-services.ts --concurrency 5
 *   npx tsx scripts/generate-poi-healthcare-medical-services.ts --buffetId <id> --dry-run
 *   npx tsx scripts/generate-poi-healthcare-medical-services.ts --resume
 *   npx tsx scripts/generate-poi-healthcare-medical-services.ts --force --limit 100
 */
...
const TARGET_GROUP = 'Healthcare & Medical Services';
// Relaxed constraints to allow more POIs per buffet
const MAX_ITEMS_PER_BUCKET = 10;
const MAX_TOTAL_ITEMS = 24;
const CHECKPOINT_DIR = path.join(__dirname, 'checkpoints');
const CHECKPOINT_FILE = path.join(CHECKPOINT_DIR, 'healthcare-medical-services.checkpoint.json');
...
type BuffetRecord = {
  id: string;
  name?: string | null;
  healthcareMedicalServices?: string | null;
...
type HealthcareMedicalServicesOutput = {
  summary: string;
...
function bucketize(category: string | null | undefined): { bucketKey: string; bucketLabel: string; typePhrase: string } {
  ...
  const bucketMap: Record<string, { bucketKey: string; bucketLabel: string; typePhrase: string }> = {
    // Hospitals & clinics
    'hospital': { bucketKey: 'hospitals', bucketLabel: 'Hospitals & clinics', typePhrase: 'hospitals and clinics' },
    'clinic': { bucketKey: 'hospitals', bucketLabel: 'Hospitals & clinics', typePhrase: 'hospitals and clinics' },
    'urgent_care': { bucketKey: 'hospitals', bucketLabel: 'Hospitals & clinics', typePhrase: 'hospitals and clinics' },
    
    // Primary care
    'doctor': { bucketKey: 'primary', bucketLabel: 'Primary care', typePhrase: 'primary care providers' },
    'doctors': { bucketKey: 'primary', bucketLabel: 'Primary care', typePhrase: 'primary care providers' },
    'physician': { bucketKey: 'primary', bucketLabel: 'Primary care', typePhrase: 'primary care providers' },
    'nurse': { bucketKey: 'primary', bucketLabel: 'Primary care', typePhrase: 'primary care providers' },
    'midwife': { bucketKey: 'primary', bucketLabel: 'Primary care', typePhrase: 'primary care providers' },
    
    // Specialists
    'dentist': { bucketKey: 'specialists', bucketLabel: 'Specialists', typePhrase: 'specialists' },
    'optometrist': { bucketKey: 'specialists', bucketLabel: 'Specialists', typePhrase: 'specialists' },
    'optician': { bucketKey: 'specialists', bucketLabel: 'Specialists', typePhrase: 'specialists' },
    'chiropractor': { bucketKey: 'specialists', bucketLabel: 'Specialists', typePhrase: 'specialists' },
    'podiatrist': { bucketKey: 'specialists', bucketLabel: 'Specialists', typePhrase: 'specialists' },
    'audiologist': { bucketKey: 'specialists', bucketLabel: 'Specialists', typePhrase: 'specialists' },
    'physiotherapist': { bucketKey: 'specialists', bucketLabel: 'Specialists', typePhrase: 'specialists' },
    'psychiatrist': { bucketKey: 'specialists', bucketLabel: 'Specialists', typePhrase: 'specialists' },
    'psychologist': { bucketKey: 'specialists', bucketLabel: 'Specialists', typePhrase: 'specialists' },
    'psychotherapist': { bucketKey: 'specialists', bucketLabel: 'Specialists', typePhrase: 'specialists' },
    
    // Pharmacy & medical supplies
    'pharmacy': { bucketKey: 'pharmacy', bucketLabel: 'Pharmacy & medical supplies', typePhrase: 'pharmacy and medical supplies' },
    'chemist': { bucketKey: 'pharmacy', bucketLabel: 'Pharmacy & medical supplies', typePhrase: 'pharmacy and medical supplies' },
    'medical_supply': { bucketKey: 'pharmacy', bucketLabel: 'Pharmacy & medical supplies', typePhrase: 'pharmacy and medical supplies' },
    'hearing_aids': { bucketKey: 'pharmacy', bucketLabel: 'Pharmacy & medical supplies', typePhrase: 'pharmacy and medical supplies' },
    'prosthetics': { bucketKey: 'pharmacy', bucketLabel: 'Pharmacy & medical supplies', typePhrase: 'pharmacy and medical supplies' },
    
    // Mental health & counseling
    'counselling': { bucketKey: 'mental', bucketLabel: 'Mental health & counseling', typePhrase: 'mental health and counseling services' },
    'counseling': { bucketKey: 'mental', bucketLabel: 'Mental health & counseling', typePhrase: 'mental health and counseling services' },
    'mental_health': { bucketKey: 'mental', bucketLabel: 'Mental health & counseling', typePhrase: 'mental health and counseling services' },
    
    // Rehabilitation & care
    'rehabilitation': { bucketKey: 'rehab', bucketLabel: 'Rehabilitation & care', typePhrase: 'rehabilitation and care services' },
    'hospice': { bucketKey: 'rehab', bucketLabel: 'Rehabilitation & care', typePhrase: 'rehabilitation and care services' },
    'nursing_home': { bucketKey: 'rehab', bucketLabel: 'Rehabilitation & care', typePhrase: 'rehabilitation and care services' },
    'home_health_care': { bucketKey: 'rehab', bucketLabel: 'Rehabilitation & care', typePhrase: 'rehabilitation and care services' },
    'homecare': { bucketKey: 'rehab', bucketLabel: 'Rehabilitation & care', typePhrase: 'rehabilitation and care services' },
    'senior_care': { bucketKey: 'rehab', bucketLabel: 'Rehabilitation & care', typePhrase: 'rehabilitation and care services' },
    'dialysis': { bucketKey: 'rehab', bucketLabel: 'Rehabilitation & care', typePhrase: 'rehabilitation and care services' },
    'nursing': { bucketKey: 'rehab', bucketLabel: 'Rehabilitation & care', typePhrase: 'rehabilitation and care services' },
    
    // Alternative medicine
    'alternative': { bucketKey: 'alternative', bucketLabel: 'Alternative medicine', typePhrase: 'alternative medicine' },
    'herbalist': { bucketKey: 'alternative', bucketLabel: 'Alternative medicine', typePhrase: 'alternative medicine' },
    'herbal_medicine': { bucketKey: 'alternative', bucketLabel: 'Alternative medicine', typePhrase: 'alternative medicine' },
    'traditional_chinese_medicine': { bucketKey: 'alternative', bucketLabel: 'Alternative medicine', typePhrase: 'alternative medicine' },
    'chinese_medicine': { bucketKey: 'alternative', bucketLabel: 'Alternative medicine', typePhrase: 'alternative medicine' },
    
    // Other healthcare
    'health': { bucketKey: 'other', bucketLabel: 'Other healthcare', typePhrase: 'healthcare services' },
    'healthcare': { bucketKey: 'other', bucketLabel: 'Other healthcare', typePhrase: 'healthcare services' },
    'medical': { bucketKey: 'other', bucketLabel: 'Other healthcare', typePhrase: 'healthcare services' },
    'massage': { bucketKey: 'other', bucketLabel: 'Other healthcare', typePhrase: 'healthcare services' },
    'maternity': { bucketKey: 'other', bucketLabel: 'Other healthcare', typePhrase: 'healthcare services' },
    'weight_loss': { bucketKey: 'other', bucketLabel: 'Other healthcare', typePhrase: 'healthcare services' },
    'nutrition_counselling': { bucketKey: 'other', bucketLabel: 'Other healthcare', typePhrase: 'healthcare services' },
    'nutrition_supplements': { bucketKey: 'other', bucketLabel: 'Other healthcare', typePhrase: 'healthcare services' },
    'blood_bank': { bucketKey: 'other', bucketLabel: 'Other healthcare', typePhrase: 'healthcare services' },
    'blood_donation': { bucketKey: 'other', bucketLabel: 'Other healthcare', typePhrase: 'healthcare services' },
    'plasma_center': { bucketKey: 'other', bucketLabel: 'Other healthcare', typePhrase: 'healthcare services' },
    'veterinary': { bucketKey: 'other', bucketLabel: 'Other healthcare', typePhrase: 'healthcare services' },
  };
  
  return bucketMap[cat] || { bucketKey: 'other', bucketLabel: 'Other healthcare & medical services', typePhrase: 'healthcare & medical services' };
}
...
function getCategoryFallback(category: string | null | undefined, tagsObj: Record<string, any>): string {
  ...
  const fallbacks: Record<string, string> = {
    ...
    'counselling': 'Counseling service',
    ...
    'nutrition_counselling': 'Nutrition counseling',
  ...
  return fallbacks[cat] || 'Healthcare service';
}
...
function dedupePois(pois: PoiRecord[]): { deduped: PoiRecord[]; removedCount: number } {
  ...
  // No special category-specific dedupe needed for Healthcare & Medical Services
...
/**
 * Update names for bucket context (no special handling needed for Healthcare & Medical Services)
 */
function updateNamesForBucketContext(items: CleanPoi[]): CleanPoi[] {
  // No special name updates needed for Healthcare & Medical Services
  return items;
}
...
function getBucketTypesSentence(
  ...
  const typeA = bucketTypePhrases[bucketKeys[0]] || 'healthcare & medical services';
  const typeB = bucketTypePhrases[bucketKeys[1]] || 'healthcare & medical services';
...
function buildSummary(extras: ProcessExtras, trimmedPois: CleanPoi[], buffetId: string): string {
  ...
  if (poiCount === 1) {
    const sentence1 = `1 healthcare service is listed ${closestSummaryDistanceText} from the buffet.`;
  ...
  // Multiple POIs
  const sentence1 = `${poiCount} healthcare & medical services are listed ${rangeText}, with the closest at ${closestSummaryDistanceText}.`;
  ...
  // No intent hooks for Healthcare & Medical Services
 ...
 */
function validateOutput(output: HealthcareMedicalServicesOutput, extras: ProcessExtras): { valid: boolean; error?: string } {
  // Check required keys
...
async function processBuffet(
...
): Promise<{ status: string; output?: HealthcareMedicalServicesOutput; poiCount?: number; removedCount?: number }> {
  ...
  // Skip if healthcareMedicalServices already exists (unless force)
  if (!options.force && buffet.healthcareMedicalServices && buffet.healthcareMedicalServices.trim().length > 0) {
    checkpoint[buffetId] = {
  ...
  // Assemble output
  const output: HealthcareMedicalServicesOutput = {
    summary,
    highlights,
  ...
  if (!options.dryRun) {
    ...
    await db.transact([db.tx.buffets[buffetId].update({ healthcareMedicalServices: jsonString })]);
  }
...
function printBuffetOutput(
  ...
  result: { 
    status: string; 
    output?: HealthcareMedicalServicesOutput;
    poiCount?: number;
    removedCount?: number;
  }
) {
  ...
  if (result.status === 'generated') {
    ...
    console.log(`STATUS: SKIPPED_EXISTING (healthcareMedicalServices already present)`);
...
async function main() {
  ...
  // Print header
  console.log('='.repeat(80));
  console.log('SEO Healthcare & Medical Services Description Generator (Deterministic)');
  console.log('='.repeat(80));
  console.log(`Target group: ${TARGET_GROUP}`);
  console.log(`Output field: buffets.healthcareMedicalServices`);
  ...
  if (buffetId) {
    ...
    while (true) {
      ...
      for (const buffet of buffets) {
        ...
        // Skip if already has healthcareMedicalServices (unless force)
        if (!force && buffet.healthcareMedicalServices && buffet.healthcareMedicalServices.trim().length > 0) {
