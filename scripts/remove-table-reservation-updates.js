// Script to remove tableReservationLinks and updatesFromCustomers fields from all buffets in the database
...
// Fields to remove
const fieldsToRemove = ['tableReservationLinks', 'updatesFromCustomers'];
