// Script to remove imageUrl field from all buffets in the database
...
// Field to remove (singular, not imageUrls plural)
const fieldToRemove = 'imageUrl';

async function removeImageUrl() {
