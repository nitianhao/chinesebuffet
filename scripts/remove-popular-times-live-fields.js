// Script to remove popularTimesLiveText and popularTimesLivePercent fields from all buffets in the database
...
// Fields to remove
const fieldsToRemove = ['popularTimesLiveText', 'popularTimesLivePercent'];
