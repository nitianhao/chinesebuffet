/**
 * Generate SEO-optimized "Recreation & Entertainment" descriptions for buffets
 * 
 ...
 * 
 * Output stored in: buffets.recreationEntertainment (JSON string)
 * 
 * Example commands:
 *   npx tsx scripts/generate-poi-recreation-entertainment.ts --dry-run --limit 5
 *   npx tsx scripts/generate-poi-recreation-entertainment.ts --concurrency 5
 *   npx tsx scripts/generate-poi-recreation-entertainment.ts --buffetId <id> --dry-run
 *   npx tsx scripts/generate-poi-recreation-entertainment.ts --resume
 *   npx tsx scripts/generate-poi-recreation-entertainment.ts --force --limit 100
 */
...
const TARGET_GROUP = 'Recreation & Entertainment';
const MAX_ITEMS_PER_BUCKET = 6;
const MAX_TOTAL_ITEMS = 12;
const CHECKPOINT_DIR = path.join(__dirname, 'checkpoints');
const CHECKPOINT_FILE = path.join(CHECKPOINT_DIR, 'recreation-entertainment.checkpoint.json');
...
type RecreationEntertainmentOutput = {
  summary: string;
...
function bucketize(category: string | null | undefined): { bucketKey: string; bucketLabel: string; typePhrase: string } {
  ...
  const bucketMap: Record<string, { bucketKey: string; bucketLabel: string; typePhrase: string }> = {
    ...
    'cinema': { bucketKey: 'entertainment', bucketLabel: 'Entertainment venues', typePhrase: 'entertainment venues' },
    'theatre': { bucketKey: 'entertainment', bucketLabel: 'Entertainment venues', typePhrase: 'entertainment venues' },
    'nightclub': { bucketKey: 'entertainment', bucketLabel: 'Entertainment venues', typePhrase: 'entertainment venues' },
    'karaoke': { bucketKey: 'entertainment', bucketLabel: 'Entertainment venues', typePhrase: 'entertainment venues' },
    'karaoke_box': { bucketKey: 'entertainment', bucketLabel: 'Entertainment venues', typePhrase: 'entertainment venues' },
    'club': { bucketKey: 'entertainment', bucketLabel: 'Entertainment venues', typePhrase: 'entertainment venues' },
    'concert_hall': { bucketKey: 'entertainment', bucketLabel: 'Entertainment venues', typePhrase: 'entertainment venues' },
    'music_venue': { bucketKey: 'entertainment', bucketLabel: 'Entertainment venues', typePhrase: 'entertainment venues' },
    'comedy': { bucketKey: 'entertainment', bucketLabel: 'Entertainment venues', typePhrase: 'entertainment venues' },
    'magic': { bucketKey: 'entertainment', bucketLabel: 'Entertainment venues', typePhrase: 'entertainment venues' },
    'magician': { bucketKey: 'entertainment', bucketLabel: 'Entertainment venues', typePhrase: 'entertainment venues' },
    
    // Gaming & arcades
    'amusement_arcade': { bucketKey: 'gaming', bucketLabel: 'Gaming & arcades', typePhrase: 'gaming and arcade venues' },
    'arcade': { bucketKey: 'gaming', bucketLabel: 'Gaming & arcades', typePhrase: 'gaming and arcade venues' },
    'escape_game': { bucketKey: 'gaming', bucketLabel: 'Gaming & arcades', typePhrase: 'gaming and arcade venues' },
    'paintball': { bucketKey: 'gaming', bucketLabel: 'Gaming & arcades', typePhrase: 'gaming and arcade venues' },
    
    // Sports & recreation
    'ice_rink': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    'golf': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    'golf_course': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    'bowling': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    'bowling_alley': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    'billiards': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    'indoor_golf': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    'disc_golf': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    'sports_centre': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    'sports_hall': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    'sports': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    'stadium': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    'track': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    'pitch': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    'swimming_pool': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    'playground': { bucketKey: 'sports', bucketLabel: 'Sports & recreation', typePhrase: 'sports and recreation facilities' },
    
    // Outdoor activities
    'scuba_diving': { bucketKey: 'outdoor', bucketLabel: 'Outdoor activities', typePhrase: 'outdoor recreation activities' },
    'water_sports': { bucketKey: 'outdoor', bucketLabel: 'Outdoor activities', typePhrase: 'outdoor recreation activities' },
    'surf': { bucketKey: 'outdoor', bucketLabel: 'Outdoor activities', typePhrase: 'outdoor recreation activities' },
    'fishing': { bucketKey: 'outdoor', bucketLabel: 'Outdoor activities', typePhrase: 'outdoor recreation activities' },
    'hunting': { bucketKey: 'outdoor', bucketLabel: 'Outdoor activities', typePhrase: 'outdoor recreation activities' },
    'dog_park': { bucketKey: 'outdoor', bucketLabel: 'Outdoor activities', typePhrase: 'outdoor recreation activities' },
    'viewpoint': { bucketKey: 'outdoor', bucketLabel: 'Outdoor activities', typePhrase: 'outdoor recreation activities' },
    'wildlife_hide': { bucketKey: 'outdoor', bucketLabel: 'Outdoor activities', typePhrase: 'outdoor recreation activities' },
    'bird_hide': { bucketKey: 'outdoor', bucketLabel: 'Outdoor activities', typePhrase: 'outdoor recreation activities' },
    
    // Parks & amenities
    'picnic_table': { bucketKey: 'parks', bucketLabel: 'Parks & amenities', typePhrase: 'parks and recreation amenities' },
    'bbq': { bucketKey: 'parks', bucketLabel: 'Parks & amenities', typePhrase: 'parks and recreation amenities' },
    'firepit': { bucketKey: 'parks', bucketLabel: 'Parks & amenities', typePhrase: 'parks and recreation amenities' },
    'fireplace': { bucketKey: 'parks', bucketLabel: 'Parks & amenities', typePhrase: 'parks and recreation amenities' },
    'bench': { bucketKey: 'parks', bucketLabel: 'Parks & amenities', typePhrase: 'parks and recreation amenities' },
    'hammock': { bucketKey: 'parks', bucketLabel: 'Parks & amenities', typePhrase: 'parks and recreation amenities' },
    'swings': { bucketKey: 'parks', bucketLabel: 'Parks & amenities', typePhrase: 'parks and recreation amenities' },
    'camp_pitch': { bucketKey: 'parks', bucketLabel: 'Parks & amenities', typePhrase: 'parks and recreation amenities' },
    
    // Arts & culture
    'museum': { bucketKey: 'arts', bucketLabel: 'Arts & culture', typePhrase: 'arts and culture venues' },
    'gallery': { bucketKey: 'arts', bucketLabel: 'Arts & culture', typePhrase: 'arts and culture venues' },
    'artwork': { bucketKey: 'arts', bucketLabel: 'Arts & culture', typePhrase: 'arts and culture venues' },
    'arts_centre': { bucketKey: 'arts', bucketLabel: 'Arts & culture', typePhrase: 'arts and culture venues' },
  };
  
  return bucketMap[cat] || { bucketKey: 'other', bucketLabel: 'Other recreation & entertainment', typePhrase: 'recreation & entertainment venues' };
}
...
function getCategoryFallback(category: string | null | undefined, tagsObj: Record<string, any>): string {
  ...
  return fallbacks[cat] || 'Recreation & entertainment venue';
}
...
function dedupePois(pois: PoiRecord[]): { deduped: PoiRecord[]; removedCount: number } {
  ...
  // No special category-specific dedupe needed for Recreation & Entertainment
...
/**
 * Update names for bucket context (no special handling needed for Recreation & Entertainment)
 */
function updateNamesForBucketContext(items: CleanPoi[]): CleanPoi[] {
  // No special name updates needed for Recreation & Entertainment
  return items;
}
...
function getBucketTypesSentence(
  ...
  const typeA = bucketTypePhrases[bucketKeys[0]] || 'recreation & entertainment venues';
  const typeB = bucketTypePhrases[bucketKeys[1]] || 'recreation & entertainment venues';
...
function buildSummary(extras: ProcessExtras, trimmedPois: CleanPoi[], buffetId: string): string {
  ...
  if (poiCount === 1) {
    const sentence1 = `1 recreation & entertainment venue is listed ${closestSummaryDistanceText} from the buffet.`;
  ...
  // Multiple POIs
  const sentence1 = `${poiCount} recreation & entertainment venues are listed ${rangeText}, with the closest at ${closestSummaryDistanceText}.`;
  ...
  // No intent hooks for Recreation & Entertainment
 ...
 */
function validateOutput(output: RecreationEntertainmentOutput, extras: ProcessExtras): { valid: boolean; error?: string } {
  // Check required keys
...
async function processBuffet(
...
): Promise<{ status: string; output?: RecreationEntertainmentOutput; poiCount?: number; removedCount?: number }> {
  ...
  // Skip if recreationEntertainment already exists (unless force)
  if (!options.force && buffet.recreationEntertainment && buffet.recreationEntertainment.trim().length > 0) {
    checkpoint[buffetId] = {
  ...
  // Assemble output
  const output: RecreationEntertainmentOutput = {
    summary,
    highlights,
  ...
  if (!options.dryRun) {
    ...
    await db.transact([db.tx.buffets[buffetId].update({ recreationEntertainment: jsonString })]);
  }
...
function printBuffetOutput(
  ...
  result: { 
    status: string; 
    output?: RecreationEntertainmentOutput;
    poiCount?: number;
    removedCount?: number;
  }
) {
  ...
  if (result.status === 'generated') {
    ...
    console.log(`STATUS: SKIPPED_EXISTING (recreationEntertainment already present)`);
...
async function main() {
  ...
  // Print header
  console.log('='.repeat(80));
  console.log('SEO Recreation & Entertainment Description Generator (Deterministic)');
  console.log('='.repeat(80));
  console.log(`Target group: ${TARGET_GROUP}`);
  console.log(`Output field: buffets.recreationEntertainment`);
  ...
  if (buffetId) {
    ...
    while (true) {
      ...
      for (const buffet of buffets) {
        ...
        // Skip if already has recreationEntertainment (unless force)
        if (!force && buffet.recreationEntertainment && buffet.recreationEntertainment.trim().length > 0) {
