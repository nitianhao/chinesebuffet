/**
 * Generate SEO-optimized "Transportation & Automotive" descriptions for buffets
 * 
 ...
 * 
 * Output stored in: buffets.transportationAutomotive (JSON string)
 * 
 * Note: This script has relaxed constraints to allow more POIs per buffet than usual.
 * 
 * Example commands:
 *   npx tsx scripts/generate-poi-transportation-automotive.ts --dry-run --limit 5
 *   npx tsx scripts/generate-poi-transportation-automotive.ts --concurrency 5
 *   npx tsx scripts/generate-poi-transportation-automotive.ts --buffetId <id> --dry-run
 *   npx tsx scripts/generate-poi-transportation-automotive.ts --resume
 *   npx tsx scripts/generate-poi-transportation-automotive.ts --force --limit 100
 */
...
const TARGET_GROUP = 'Transportation & Automotive';
...
const CHECKPOINT_FILE = path.join(CHECKPOINT_DIR, 'transportation-automotive.checkpoint.json');
...
type TransportationAutomotiveOutput = {
  summary: string;
...
function bucketize(category: string | null | undefined): { bucketKey: string; bucketLabel: string; typePhrase: string } {
  ...
  const bucketMap: Record<string, { bucketKey: string; bucketLabel: string; typePhrase: string }> = {
    // Parking facilities
    'parking': { bucketKey: 'parking', bucketLabel: 'Parking facilities', typePhrase: 'parking facilities' },
    'parking_space': { bucketKey: 'parking', bucketLabel: 'Parking facilities', typePhrase: 'parking facilities' },
    'parking_entrance': { bucketKey: 'parking', bucketLabel: 'Parking facilities', typePhrase: 'parking facilities' },
    'parking_exit': { bucketKey: 'parking', bucketLabel: 'Parking facilities', typePhrase: 'parking facilities' },
    'bicycle_parking': { bucketKey: 'parking', bucketLabel: 'Parking facilities', typePhrase: 'parking facilities' },
    'motorcycle_parking': { bucketKey: 'parking', bucketLabel: 'Parking facilities', typePhrase: 'parking facilities' },
    'scooter_parking': { bucketKey: 'parking', bucketLabel: 'Parking facilities', typePhrase: 'parking facilities' },
    'skateboard_parking': { bucketKey: 'parking', bucketLabel: 'Parking facilities', typePhrase: 'parking facilities' },
    
    // Vehicle services
    'car_repair': { bucketKey: 'services', bucketLabel: 'Vehicle services', typePhrase: 'vehicle services' },
    'car_wash': { bucketKey: 'services', bucketLabel: 'Vehicle services', typePhrase: 'vehicle services' },
    'car_detail': { bucketKey: 'services', bucketLabel: 'Vehicle services', typePhrase: 'vehicle services' },
    'car_bodyshop': { bucketKey: 'services', bucketLabel: 'Vehicle services', typePhrase: 'vehicle services' },
    'car_audio': { bucketKey: 'services', bucketLabel: 'Vehicle services', typePhrase: 'vehicle services' },
    'motorcycle_repair': { bucketKey: 'services', bucketLabel: 'Vehicle services', typePhrase: 'vehicle services' },
    'bicycle_repair': { bucketKey: 'services', bucketLabel: 'Vehicle services', typePhrase: 'vehicle services' },
    'bicycle_repair_station': { bucketKey: 'services', bucketLabel: 'Vehicle services', typePhrase: 'vehicle services' },
    'towing': { bucketKey: 'services', bucketLabel: 'Vehicle services', typePhrase: 'vehicle services' },
    'vehicle_inspection': { bucketKey: 'services', bucketLabel: 'Vehicle services', typePhrase: 'vehicle services' },
    'tyres': { bucketKey: 'services', bucketLabel: 'Vehicle services', typePhrase: 'vehicle services' },
    'compressed_air': { bucketKey: 'services', bucketLabel: 'Vehicle services', typePhrase: 'vehicle services' },
    'weighbridge': { bucketKey: 'services', bucketLabel: 'Vehicle services', typePhrase: 'vehicle services' },
    
    // Vehicle rentals
    'car_rental': { bucketKey: 'rentals', bucketLabel: 'Vehicle rentals', typePhrase: 'vehicle rentals' },
    'car_sharing': { bucketKey: 'rentals', bucketLabel: 'Vehicle rentals', typePhrase: 'vehicle rentals' },
    'motorcycle_rental': { bucketKey: 'rentals', bucketLabel: 'Vehicle rentals', typePhrase: 'vehicle rentals' },
    'bicycle_rental': { bucketKey: 'rentals', bucketLabel: 'Vehicle rentals', typePhrase: 'vehicle rentals' },
    'scooter_rental': { bucketKey: 'rentals', bucketLabel: 'Vehicle rentals', typePhrase: 'vehicle rentals' },
    'scooter_share': { bucketKey: 'rentals', bucketLabel: 'Vehicle rentals', typePhrase: 'vehicle rentals' },
    'limousine': { bucketKey: 'rentals', bucketLabel: 'Vehicle rentals', typePhrase: 'vehicle rentals' },
    'limousine_service': { bucketKey: 'rentals', bucketLabel: 'Vehicle rentals', typePhrase: 'vehicle rentals' },
    'shuttle': { bucketKey: 'rentals', bucketLabel: 'Vehicle rentals', typePhrase: 'vehicle rentals' },
    'atv': { bucketKey: 'rentals', bucketLabel: 'Vehicle rentals', typePhrase: 'vehicle rentals' },
    'e-bike': { bucketKey: 'rentals', bucketLabel: 'Vehicle rentals', typePhrase: 'vehicle rentals' },
    'e_scooter': { bucketKey: 'rentals', bucketLabel: 'Vehicle rentals', typePhrase: 'vehicle rentals' },
    
    // Fuel & charging
    'fuel': { bucketKey: 'fuel', bucketLabel: 'Fuel & charging', typePhrase: 'fuel and charging stations' },
    'charging_station': { bucketKey: 'fuel', bucketLabel: 'Fuel & charging', typePhrase: 'fuel and charging stations' },
    
    // Public transportation
    'taxi': { bucketKey: 'public', bucketLabel: 'Public transportation', typePhrase: 'public transportation' },
    'bus_station': { bucketKey: 'public', bucketLabel: 'Public transportation', typePhrase: 'public transportation' },
    'ferry_terminal': { bucketKey: 'public', bucketLabel: 'Public transportation', typePhrase: 'public transportation' },
    'tourist_bus': { bucketKey: 'public', bucketLabel: 'Public transportation', typePhrase: 'public transportation' },
    
    // Vehicle parts & accessories
    'car_parts': { bucketKey: 'parts', bucketLabel: 'Vehicle parts & accessories', typePhrase: 'vehicle parts and accessories' },
    
    // Other transportation
    'car': { bucketKey: 'other', bucketLabel: 'Other transportation', typePhrase: 'transportation services' },
    'motorcycle': { bucketKey: 'other', bucketLabel: 'Other transportation', typePhrase: 'transportation services' },
    'bicycle': { bucketKey: 'other', bucketLabel: 'Other transportation', typePhrase: 'transportation services' },
    'scooter': { bucketKey: 'other', bucketLabel: 'Other transportation', typePhrase: 'transportation services' },
    'truck': { bucketKey: 'other', bucketLabel: 'Other transportation', typePhrase: 'transportation services' },
    'skateboard': { bucketKey: 'other', bucketLabel: 'Other transportation', typePhrase: 'transportation services' },
  };
  
  return bucketMap[cat] || { bucketKey: 'other', bucketLabel: 'Other transportation & automotive', typePhrase: 'transportation & automotive services' };
}
...
function getCategoryFallback(category: string | null | undefined, tagsObj: Record<string, any>): string {
  ...
  const fallbacks: Record<string, string> = {
    ...
    'scooter_parking': 'Scooter parking',
    'skateboard_parking': 'Skateboard parking',
    'car_repair': 'Auto repair shop',
    'car_wash': 'Car wash',
    'car_detail': 'Car detailing',
    'car_bodyshop': 'Auto body shop',
    'car_audio': 'Car audio shop',
    ...
    'tyres': 'Tire shop',
    'compressed_air': 'Compressed air station',
    ...
    'bicycle': 'Bicycle service',
    'scooter': 'Scooter service',
    'truck': 'Truck service',
    'skateboard': 'Skateboard service',
  };
  
  return fallbacks[cat] || 'Transportation service';
}
...
function dedupePois(pois: PoiRecord[]): { deduped: PoiRecord[]; removedCount: number } {
  ...
  // No special category-specific dedupe needed for Transportation & Automotive
...
/**
 * Update names for bucket context (no special handling needed for Transportation & Automotive)
 */
function updateNamesForBucketContext(items: CleanPoi[]): CleanPoi[] {
  // No special name updates needed for Transportation & Automotive
  return items;
}
 ...
 */
function validateOutput(output: TransportationAutomotiveOutput, extras: ProcessExtras): { valid: boolean; error?: string } {
  // Check required keys
...
async function processBuffet(
...
): Promise<{ status: string; output?: TransportationAutomotiveOutput; poiCount?: number; removedCount?: number }> {
  ...
  // Skip if transportationAutomotive already exists (unless force)
  if (!options.force && buffet.transportationAutomotive && buffet.transportationAutomotive.trim().length > 0) {
    checkpoint[buffetId] = {
  ...
  // Assemble output
  const output: TransportationAutomotiveOutput = {
    summary,
    highlights,
  ...
  if (!options.dryRun) {
    ...
    await db.transact([db.tx.buffets[buffetId].update({ transportationAutomotive: jsonString })]);
  }
...
function printBuffetOutput(
  ...
  result: { 
    status: string; 
    output?: TransportationAutomotiveOutput;
    poiCount?: number;
    removedCount?: number;
  }
) {
  ...
  if (result.status === 'generated') {
    ...
    console.log(`STATUS: SKIPPED_EXISTING (transportationAutomotive already present)`);
...
async function main() {
  ...
  // Print header
  console.log('='.repeat(80));
  console.log('SEO Transportation & Automotive Description Generator (Deterministic)');
  console.log('='.repeat(80));
  console.log(`Target group: ${TARGET_GROUP}`);
  console.log(`Output field: buffets.transportationAutomotive`);
  ...
  if (buffetId) {
    ...
    while (true) {
      ...
      for (const buffet of buffets) {
        ...
        // Skip if already has transportationAutomotive (unless force)
        if (!force && buffet.transportationAutomotive && buffet.transportationAutomotive.trim().length > 0) {
