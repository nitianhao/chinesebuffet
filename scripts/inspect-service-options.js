...
async function inspectServiceOptions() {
  ...
  try {
    ...
    console.log('Fetching serviceOptions records...');
    
    // Fetch serviceOptions records (limit to a sample)
    ...
    console.log(`Found ${records.length} serviceOptions records (sampling first 100)\n`);
