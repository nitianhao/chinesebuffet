// Script to remove imageUrls, inputPlaceId, and kgmid fields from all buffets in the database
...
// Fields to remove
const fieldsToRemove = ['imageUrls', 'inputPlaceId', 'kgmid'];

async function removeThreeFields() {
