/**
 * Generate SEO-optimized "Retail & Shopping" descriptions for buffets
 * 
 ...
 * 
 * Output stored in: buffets.retailShopping (JSON string)
 * 
 * Example commands:
 *   npx tsx scripts/generate-poi-retail-shopping.ts --dry-run --limit 5
 *   npx tsx scripts/generate-poi-retail-shopping.ts --concurrency 5
 *   npx tsx scripts/generate-poi-retail-shopping.ts --buffetId <id> --dry-run
 *   npx tsx scripts/generate-poi-retail-shopping.ts --resume
 *   npx tsx scripts/generate-poi-retail-shopping.ts --force --limit 100
 */
...
import { buildVariedSummary, ProcessExtras } from './poi-summary-utils';
...
const TARGET_GROUP = 'Retail & Shopping';
const MAX_ITEMS_PER_BUCKET = 6;
const MAX_TOTAL_ITEMS = 12;
const CHECKPOINT_DIR = path.join(__dirname, 'checkpoints');
const CHECKPOINT_FILE = path.join(CHECKPOINT_DIR, 'retail-shopping.checkpoint.json');
...
// ProcessExtras is imported from poi-summary-utils
...
function bucketize(category: string | null | undefined): { bucketKey: string; bucketLabel: string; typePhrase: string } {
  ...
  const bucketMap: Record<string, { bucketKey: string; bucketLabel: string; typePhrase: string }> = {
    // General retail
    'shop': { bucketKey: 'general', bucketLabel: 'General retail', typePhrase: 'retail stores' },
    'store': { bucketKey: 'general', bucketLabel: 'General retail', typePhrase: 'retail stores' },
    'retail': { bucketKey: 'general', bucketLabel: 'General retail', typePhrase: 'retail stores' },
    'department_store': { bucketKey: 'general', bucketLabel: 'General retail', typePhrase: 'retail stores' },
    'variety_store': { bucketKey: 'general', bucketLabel: 'General retail', typePhrase: 'retail stores' },
    'mall': { bucketKey: 'general', bucketLabel: 'General retail', typePhrase: 'retail stores' },
    'market': { bucketKey: 'general', bucketLabel: 'General retail', typePhrase: 'retail stores' },
    'marketplace': { bucketKey: 'general', bucketLabel: 'General retail', typePhrase: 'retail stores' },
    'kiosk': { bucketKey: 'general', bucketLabel: 'General retail', typePhrase: 'retail stores' },
    
    // Clothing & fashion
    'clothes': { bucketKey: 'clothing', bucketLabel: 'Clothing & fashion', typePhrase: 'clothing and fashion stores' },
    'shoes': { bucketKey: 'clothing', bucketLabel: 'Clothing & fashion', typePhrase: 'clothing and fashion stores' },
    'fashion': { bucketKey: 'clothing', bucketLabel: 'Clothing & fashion', typePhrase: 'clothing and fashion stores' },
    'fashion_accessories': { bucketKey: 'clothing', bucketLabel: 'Clothing & fashion', typePhrase: 'clothing and fashion stores' },
    'vintage_clothing': { bucketKey: 'clothing', bucketLabel: 'Clothing & fashion', typePhrase: 'clothing and fashion stores' },
    'boutique': { bucketKey: 'clothing', bucketLabel: 'Clothing & fashion', typePhrase: 'clothing and fashion stores' },
    
    // Electronics & technology
    'electronics': { bucketKey: 'electronics', bucketLabel: 'Electronics & technology', typePhrase: 'electronics and technology stores' },
    'computer': { bucketKey: 'electronics', bucketLabel: 'Electronics & technology', typePhrase: 'electronics and technology stores' },
    'mobile_phone': { bucketKey: 'electronics', bucketLabel: 'Electronics & technology', typePhrase: 'electronics and technology stores' },
    'video_games': { bucketKey: 'electronics', bucketLabel: 'Electronics & technology', typePhrase: 'electronics and technology stores' },
    'games': { bucketKey: 'electronics', bucketLabel: 'Electronics & technology', typePhrase: 'electronics and technology stores' },
    'music': { bucketKey: 'electronics', bucketLabel: 'Electronics & technology', typePhrase: 'electronics and technology stores' },
    'video': { bucketKey: 'electronics', bucketLabel: 'Electronics & technology', typePhrase: 'electronics and technology stores' },
    
    // Home & garden
    'hardware': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'hardware_store': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'furniture': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'home_goods_store': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'kitchenware': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'cookware': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'bedding': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'carpet': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'curtain': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'fabric': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'flooring': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'tiles': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'paint': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'lighting': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'appliance': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'houseware': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'household': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    'garden_centre': { bucketKey: 'home', bucketLabel: 'Home & garden', typePhrase: 'home and garden stores' },
    
    // Specialty stores
    'jewelry': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    'books': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    'toys': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    'cosmetics': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    'perfumery': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    'gift': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    'tobacco': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    'cannabis': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    'dispensary': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    'second_hand': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    'antiques': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    'collector': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    'hobby': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    'musical_instrument': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    'baby_goods': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    'stationery': { bucketKey: 'specialty', bucketLabel: 'Specialty stores', typePhrase: 'specialty stores' },
    
    // Pet stores
    'pet': { bucketKey: 'pet', bucketLabel: 'Pet stores', typePhrase: 'pet stores' },
    
    // Sports & outdoor
    'sports': { bucketKey: 'sports', bucketLabel: 'Sports & outdoor', typePhrase: 'sports and outdoor stores' },
    'bicycle': { bucketKey: 'sports', bucketLabel: 'Sports & outdoor', typePhrase: 'sports and outdoor stores' },
  };
  
  return bucketMap[cat] || { bucketKey: 'other', bucketLabel: 'Other retail & shopping', typePhrase: 'retail & shopping stores' };
}
...
function getCategoryFallback(category: string | null | undefined, tagsObj: Record<string, any>): string {
  ...
  return fallbacks[cat] || 'Retail store';
}
...
function dedupePois(pois: PoiRecord[]): { deduped: PoiRecord[]; removedCount: number } {
  ...
  // No special category-specific dedupe needed for Retail & Shopping
...
/**
 * Update names for bucket context (no special handling needed for Retail & Shopping)
 */
function updateNamesForBucketContext(items: CleanPoi[]): CleanPoi[] {
  // No special name updates needed for Retail & Shopping
  return items;
}
...
/**
 * Build varied summary using shared utility
 ...
 */
function validateOutput(output: RetailShoppingOutput, extras: ProcessExtras): { valid: boolean; error?: string } {
  // Check required keys
...
async function processBuffet(
...
): Promise<{ status: string; output?: RetailShoppingOutput; poiCount?: number; removedCount?: number }> {
  ...
  // Skip if retailShopping already exists (unless force)
  if (!options.force && buffet.retailShopping && buffet.retailShopping.trim().length > 0) {
    checkpoint[buffetId] = {
  ...
  // Assemble output
  const output: RetailShoppingOutput = {
    summary,
    highlights,
  ...
  if (!options.dryRun) {
    ...
    await db.transact([db.tx.buffets[buffetId].update({ retailShopping: jsonString })]);
  }
...
function printBuffetOutput(
  ...
  if (result.status === 'generated') {
    ...
    console.log(`STATUS: SKIPPED_EXISTING (retailShopping already present)`);
...
async function main() {
  ...
  // Print header
  console.log('='.repeat(80));
  console.log('SEO Retail & Shopping Description Generator (Deterministic)');
  console.log('='.repeat(80));
  console.log(`Target group: ${TARGET_GROUP}`);
  console.log(`Output field: buffets.retailShopping`);
  ...
  if (buffetId) {
    ...
    while (true) {
      ...
      for (const buffet of buffets) {
        ...
        // Skip if already has retailShopping (unless force)
        if (!force && buffet.retailShopping && buffet.retailShopping.trim().length > 0) {
