// Script to remove tripadvisorRating, tripadvisorReviewsCount, and tripadvisorData fields from all buffets in the database
...
// Fields to remove
const fieldsToRemove = ['tripadvisorRating', 'tripadvisorReviewsCount', 'tripadvisorData'];

async function removeTripAdvisorFields() {
