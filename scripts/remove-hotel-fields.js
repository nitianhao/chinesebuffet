// Script to remove hotel-related fields from all buffets in the database
...
// Hotel-related fields to remove
...
async function removeHotelFields() {
  ...
  try {
    ...
    console.log(`\n✓ Successfully removed hotel fields from ${updatedCount} buffets!`);
