/**
 * Generate SEO-optimized "Professional & Business Services" descriptions for buffets
 * 
 ...
 * 
 * Output stored in: buffets.professionalBusinessServices (JSON string)
 * 
 * Example commands:
 *   npx tsx scripts/generate-poi-professional-business-services.ts --dry-run --limit 5
 *   npx tsx scripts/generate-poi-professional-business-services.ts --concurrency 5
 *   npx tsx scripts/generate-poi-professional-business-services.ts --buffetId <id> --dry-run
 *   npx tsx scripts/generate-poi-professional-business-services.ts --resume
 *   npx tsx scripts/generate-poi-professional-business-services.ts --force --limit 100
 */
...
const TARGET_GROUP = 'Professional & Business Services';
const MAX_ITEMS_PER_BUCKET = 6;
const MAX_TOTAL_ITEMS = 12;
const CHECKPOINT_DIR = path.join(__dirname, 'checkpoints');
const CHECKPOINT_FILE = path.join(CHECKPOINT_DIR, 'professional-business-services.checkpoint.json');
...
type BuffetRecord = {
  id: string;
  name?: string | null;
  professionalBusinessServices?: string | null;
...
type ProfessionalBusinessServicesOutput = {
  summary: string;
...
function bucketize(category: string | null | undefined): { bucketKey: string; bucketLabel: string; typePhrase: string } {
  ...
  const bucketMap: Record<string, { bucketKey: string; bucketLabel: string; typePhrase: string }> = {
    // Legal services
    'lawyer': { bucketKey: 'legal', bucketLabel: 'Legal services', typePhrase: 'legal services' },
    'notary': { bucketKey: 'legal', bucketLabel: 'Legal services', typePhrase: 'legal services' },
    'process_server': { bucketKey: 'legal', bucketLabel: 'Legal services', typePhrase: 'legal services' },
    'bail_bond': { bucketKey: 'legal', bucketLabel: 'Legal services', typePhrase: 'legal services' },
    'bail_bond_agent': { bucketKey: 'legal', bucketLabel: 'Legal services', typePhrase: 'legal services' },
    'bailbond': { bucketKey: 'legal', bucketLabel: 'Legal services', typePhrase: 'legal services' },
    
    // Financial & accounting
    'accountant': { bucketKey: 'financial', bucketLabel: 'Financial & accounting services', typePhrase: 'financial and accounting services' },
    'financial_advisor': { bucketKey: 'financial', bucketLabel: 'Financial & accounting services', typePhrase: 'financial and accounting services' },
    'tax_advisor': { bucketKey: 'financial', bucketLabel: 'Financial & accounting services', typePhrase: 'financial and accounting services' },
    'tax_preparation': { bucketKey: 'financial', bucketLabel: 'Financial & accounting services', typePhrase: 'financial and accounting services' },
    'insurance': { bucketKey: 'financial', bucketLabel: 'Financial & accounting services', typePhrase: 'financial and accounting services' },
    
    // Real estate
    'realty': { bucketKey: 'real_estate', bucketLabel: 'Real estate services', typePhrase: 'real estate services' },
    'estate_agent': { bucketKey: 'real_estate', bucketLabel: 'Real estate services', typePhrase: 'real estate services' },
    'property_management': { bucketKey: 'real_estate', bucketLabel: 'Real estate services', typePhrase: 'real estate services' },
    
    // Technology & IT
    'it': { bucketKey: 'technology', bucketLabel: 'Technology & IT services', typePhrase: 'technology and IT services' },
    'it_services': { bucketKey: 'technology', bucketLabel: 'Technology & IT services', typePhrase: 'technology and IT services' },
    'software': { bucketKey: 'technology', bucketLabel: 'Technology & IT services', typePhrase: 'technology and IT services' },
    'software_company': { bucketKey: 'technology', bucketLabel: 'Technology & IT services', typePhrase: 'technology and IT services' },
    'web_design': { bucketKey: 'technology', bucketLabel: 'Technology & IT services', typePhrase: 'technology and IT services' },
    'web_development': { bucketKey: 'technology', bucketLabel: 'Technology & IT services', typePhrase: 'technology and IT services' },
    'graphic_design': { bucketKey: 'technology', bucketLabel: 'Technology & IT services', typePhrase: 'technology and IT services' },
    'telecommunication': { bucketKey: 'technology', bucketLabel: 'Technology & IT services', typePhrase: 'technology and IT services' },
    
    // Marketing & advertising
    'advertising': { bucketKey: 'marketing', bucketLabel: 'Marketing & advertising', typePhrase: 'marketing and advertising services' },
    'advertising_agency': { bucketKey: 'marketing', bucketLabel: 'Marketing & advertising', typePhrase: 'marketing and advertising services' },
    
    // Professional services
    'architect': { bucketKey: 'professional', bucketLabel: 'Professional services', typePhrase: 'professional services' },
    'engineer': { bucketKey: 'professional', bucketLabel: 'Professional services', typePhrase: 'professional services' },
    'surveyor': { bucketKey: 'professional', bucketLabel: 'Professional services', typePhrase: 'professional services' },
    'consulting': { bucketKey: 'professional', bucketLabel: 'Professional services', typePhrase: 'professional services' },
    'management': { bucketKey: 'professional', bucketLabel: 'Professional services', typePhrase: 'professional services' },
    'company': { bucketKey: 'professional', bucketLabel: 'Professional services', typePhrase: 'professional services' },
    'office': { bucketKey: 'professional', bucketLabel: 'Professional services', typePhrase: 'professional services' },
    'coworking': { bucketKey: 'professional', bucketLabel: 'Professional services', typePhrase: 'professional services' },
    'coworking_space': { bucketKey: 'professional', bucketLabel: 'Professional services', typePhrase: 'professional services' },
    
    // Security & investigation
    'security': { bucketKey: 'security', bucketLabel: 'Security & investigation', typePhrase: 'security and investigation services' },
    'detective': { bucketKey: 'security', bucketLabel: 'Security & investigation', typePhrase: 'security and investigation services' },
    'private_investigator': { bucketKey: 'security', bucketLabel: 'Security & investigation', typePhrase: 'security and investigation services' },
    
    // Employment & recruitment
    'employment_agency': { bucketKey: 'employment', bucketLabel: 'Employment & recruitment', typePhrase: 'employment and recruitment services' },
    'recruiting': { bucketKey: 'employment', bucketLabel: 'Employment & recruitment', typePhrase: 'employment and recruitment services' },
    'recruitment': { bucketKey: 'employment', bucketLabel: 'Employment & recruitment', typePhrase: 'employment and recruitment services' },
    
    // Translation services
    'translator': { bucketKey: 'translation', bucketLabel: 'Translation services', typePhrase: 'translation services' },
    'interpreter': { bucketKey: 'translation', bucketLabel: 'Translation services', typePhrase: 'translation services' },
    
    // Travel services
    'travel_agency': { bucketKey: 'travel', bucketLabel: 'Travel services', typePhrase: 'travel services' },
    'travel_agent': { bucketKey: 'travel', bucketLabel: 'Travel services', typePhrase: 'travel services' },
    
    // Logistics & shipping
    'logistics': { bucketKey: 'logistics', bucketLabel: 'Logistics & shipping', typePhrase: 'logistics and shipping services' },
    'moving_company': { bucketKey: 'logistics', bucketLabel: 'Logistics & shipping', typePhrase: 'logistics and shipping services' },
    'shipping': { bucketKey: 'logistics', bucketLabel: 'Logistics & shipping', typePhrase: 'logistics and shipping services' },
    'courier': { bucketKey: 'logistics', bucketLabel: 'Logistics & shipping', typePhrase: 'logistics and shipping services' },
    
    // Maintenance services
    'cleaning': { bucketKey: 'maintenance', bucketLabel: 'Maintenance services', typePhrase: 'maintenance services' },
    'pest_control': { bucketKey: 'maintenance', bucketLabel: 'Maintenance services', typePhrase: 'maintenance services' },
    'exterminator': { bucketKey: 'maintenance', bucketLabel: 'Maintenance services', typePhrase: 'maintenance services' },
    'locksmith': { bucketKey: 'maintenance', bucketLabel: 'Maintenance services', typePhrase: 'maintenance services' },
    
    // Commercial services
    'commercial_kitchen': { bucketKey: 'commercial', bucketLabel: 'Commercial services', typePhrase: 'commercial services' },
  };
  
  return bucketMap[cat] || { bucketKey: 'other', bucketLabel: 'Other professional & business services', typePhrase: 'professional & business services' };
}
...
function getCategoryFallback(category: string | null | undefined, tagsObj: Record<string, any>): string {
  ...
  const fallbacks: Record<string, string> = {
    ...
    'bail_bond': 'Bail bond service',
    'bail_bond_agent': 'Bail bond agent',
    'bailbond': 'Bail bond service',
    ...
    'graphic_design': 'Graphic design service',
  ...
  return fallbacks[cat] || 'Professional & business service';
}
...
function dedupePois(pois: PoiRecord[]): { deduped: PoiRecord[]; removedCount: number } {
  ...
  // No special category-specific dedupe needed for Professional & Business Services
...
/**
 * Update names for bucket context (no special handling needed for Professional & Business Services)
 */
function updateNamesForBucketContext(items: CleanPoi[]): CleanPoi[] {
  // No special name updates needed for Professional & Business Services
  return items;
}
...
function getBucketTypesSentence(
  ...
  const typeA = bucketTypePhrases[bucketKeys[0]] || 'professional & business services';
  const typeB = bucketTypePhrases[bucketKeys[1]] || 'professional & business services';
...
function buildSummary(extras: ProcessExtras, trimmedPois: CleanPoi[], buffetId: string): string {
  ...
  if (poiCount === 1) {
    const sentence1 = `1 professional & business service is listed ${closestSummaryDistanceText} from the buffet.`;
  ...
  // Multiple POIs
  const sentence1 = `${poiCount} professional & business services are listed ${rangeText}, with the closest at ${closestSummaryDistanceText}.`;
  ...
  // No intent hooks for Professional & Business Services
 ...
 */
function validateOutput(output: ProfessionalBusinessServicesOutput, extras: ProcessExtras): { valid: boolean; error?: string } {
  // Check required keys
...
async function processBuffet(
...
): Promise<{ status: string; output?: ProfessionalBusinessServicesOutput; poiCount?: number; removedCount?: number }> {
  ...
  // Skip if professionalBusinessServices already exists (unless force)
  if (!options.force && buffet.professionalBusinessServices && buffet.professionalBusinessServices.trim().length > 0) {
    checkpoint[buffetId] = {
  ...
  // Assemble output
  const output: ProfessionalBusinessServicesOutput = {
    summary,
    highlights,
  ...
  if (!options.dryRun) {
    ...
    await db.transact([db.tx.buffets[buffetId].update({ professionalBusinessServices: jsonString })]);
  }
...
function printBuffetOutput(
  ...
  result: { 
    status: string; 
    output?: ProfessionalBusinessServicesOutput;
    poiCount?: number;
    removedCount?: number;
  }
) {
  ...
  if (result.status === 'generated') {
    ...
    console.log(`STATUS: SKIPPED_EXISTING (professionalBusinessServices already present)`);
...
async function main() {
  ...
  // Print header
  console.log('='.repeat(80));
  console.log('SEO Professional & Business Services Description Generator (Deterministic)');
  console.log('='.repeat(80));
  console.log(`Target group: ${TARGET_GROUP}`);
  console.log(`Output field: buffets.professionalBusinessServices`);
  ...
  if (buffetId) {
    ...
    while (true) {
      ...
      for (const buffet of buffets) {
        ...
        // Skip if already has professionalBusinessServices (unless force)
        if (!force && buffet.professionalBusinessServices && buffet.professionalBusinessServices.trim().length > 0) {
