// Script to remove yelpRating and yelpReviewsCount fields from all buffets in the database
...
// Fields to remove
const fieldsToRemove = ['yelpRating', 'yelpReviewsCount'];

async function removeYelpFields() {
