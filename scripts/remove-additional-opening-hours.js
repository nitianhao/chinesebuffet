// Script to remove additionalOpeningHours field from all buffets in the database
...
// Field to remove
const fieldToRemove = 'additionalOpeningHours';

async function removeAdditionalOpeningHours() {
