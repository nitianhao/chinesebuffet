// Script to remove openingHoursBusinessConfirmationText and ownerUpdates fields from all buffets in the database
...
// Fields to remove
const fieldsToRemove = ['openingHoursBusinessConfirmationText', 'ownerUpdates'];
