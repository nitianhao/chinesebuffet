// Script to remove isAdvertisement field from all buffets in the database
...
// Field to remove
const fieldToRemove = 'isAdvertisement';

async function removeIsAdvertisement() {
