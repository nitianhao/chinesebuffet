    ...
    <div className="space-y-4">
      {qna.map((item, index) => (
        ...
        >
          ...
          {item.question && (
            <div className="mb-3">
              <div className="flex items-start gap-2 mb-1">
                <svg className="w-5 h-5 text-[var(--accent1)] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Answer */}
          {item.answer && (
            <div className="ml-7 pl-4 border-l-2 border-[var(--border)]">
